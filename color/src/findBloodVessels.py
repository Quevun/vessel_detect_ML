...
if __name__ == '__main__':
    ...
    mat_content = scipy.io.loadmat('../data/nn_param/deriv_order2.mat')
    ...
    cv2.imwrite('../data/findBloodVessels_results/deriv_order2/'+filename+'.jpg',predict.astype(np.uint8)*255)